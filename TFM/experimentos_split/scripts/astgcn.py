...
trainer_gt,params_gt, resultados_final_gt, resultados_gt = entrenar_y_evaluar_modelos_astgcn(param_grid, dataset_gt, dataloader_params2, num_early_stop, num_epochs, problem=problem)
